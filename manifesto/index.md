...
<img src="{% link images/manifesto/lakehouse.jpg %}" alt="An actual lakehouse" width="750" height="562" />
...
<img src="{% link images/manifesto/iceberg-table-architecture.png %}" alt="Iceberg table architecture" width="750" height="351" class="lightmode-img" />
<img src="{% link images/manifesto/dark/iceberg-table-architecture.png %}" alt="Iceberg table architecture" width="750" height="351" class="darkmode-img" />
...
<img src="{% link images/manifesto/iceberg-catalog-architecture.png %}" alt="Iceberg catalog architecture" width="750" height="555" class="lightmode-img" />
<img src="{% link images/manifesto/dark/iceberg-catalog-architecture.png %}" alt="Iceberg catalog architecture" width="750" height="555" class="darkmode-img" />
...
<img src="{% link images/manifesto/ducklake-architecture.png %}" alt="DuckLake's architecture" width="750" height="597" class="lightmode-img" />
<img src="{% link images/manifesto/dark/ducklake-architecture.png %}" alt="DuckLake's architecture" width="750" height="597" class="darkmode-img" />
...
<img src="{% link images/manifesto/ducklake-schema-1.png %}" alt="DuckLake schema" width="750" height="1070" class="lightmode-img" />
<img src="{% link images/manifesto/dark/ducklake-schema-1.png %}" alt="DuckLake schema" width="750" height="1070" class="darkmode-img" />
