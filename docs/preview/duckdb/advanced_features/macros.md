...
Macros support [time travel]({% link docs/preview/duckdb/usage/time_travel.md %}), so attaching at a previous snapshot will reflect the macros that existed at that point in time.
