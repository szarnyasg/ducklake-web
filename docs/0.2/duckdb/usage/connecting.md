...
In the `ATTACH` command, you must specify the [catalog database]({% link docs/0.2/duckdb/usage/choosing_a_catalog_database.md %}) and the [data storage location]({% link docs/0.2/duckdb/usage/choosing_storage.md %}).
...
| data_inlining_row_limit | The number of rows for which [data inlining]({% link docs/0.2/duckdb/advanced_features/data_inlining.md %}) is used | 0                                                            |
