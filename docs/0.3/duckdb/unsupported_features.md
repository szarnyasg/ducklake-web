...
- Upserting is only supported via the [`MERGE INTO`]({% link docs/0.3/duckdb/usage/upserting.md %}) syntax since primary keys are not supported in DuckLake.
...
- [Data inlining]({% link docs/0.3/duckdb/advanced_features/data_inlining.md %}) is limited to DuckDB catalogs
