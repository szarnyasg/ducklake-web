...
Unless [data inlining is used]({% link docs/0.3/duckdb/advanced_features/data_inlining.md %}), each insert to DuckLake writes data to a new Parquet file.
...
> See the [cleanup old files]({% link docs/0.3/duckdb/maintenance/cleanup_of_files.md %}) section on how to trigger a cleanup of these files.
