...
* [Data Types]({% link docs/0.3/specification/data_types.md %})
* [Queries]({% link docs/0.3/specification/queries.md %})
* [Tables]({% link docs/0.3/specification/tables/overview.md %})

If you are reading this specification for the first time,
we recommend starting with the [“Queries” page]({% link docs/0.3/specification/queries.md %}),
