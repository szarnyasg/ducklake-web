...
* [`ducklake_snapshot`]({% link docs/0.4/specification/tables/ducklake_snapshot.md %})
* [`ducklake_snapshot_changes`]({% link docs/0.4/specification/tables/ducklake_snapshot_changes.md %})

## DuckLake Schema

* [`ducklake_schema`]({% link docs/0.4/specification/tables/ducklake_schema.md %})
* [`ducklake_table`]({% link docs/0.4/specification/tables/ducklake_table.md %})
* [`ducklake_view`]({% link docs/0.4/specification/tables/ducklake_view.md %})
* [`ducklake_column`]({% link docs/0.4/specification/tables/ducklake_column.md %})

## Macros

* [`ducklake_macro`]({% link docs/0.4/specification/tables/ducklake_macro.md %})
* [`ducklake_macro_impl`]({% link docs/0.4/specification/tables/ducklake_macro_impl.md %})
* [`ducklake_macro_parameters`]({% link docs/0.4/specification/tables/ducklake_macro_parameters.md %})

## Data Files and Tables

* [`ducklake_data_file`]({% link docs/0.4/specification/tables/ducklake_data_file.md %})
* [`ducklake_delete_file`]({% link docs/0.4/specification/tables/ducklake_delete_file.md %})
* [`ducklake_files_scheduled_for_deletion`]({% link docs/0.4/specification/tables/ducklake_files_scheduled_for_deletion.md %})
* [`ducklake_inlined_data_tables`]({% link docs/0.4/specification/tables/ducklake_inlined_data_tables.md %})

## Data File Mapping

* [`ducklake_column_mapping`]({% link docs/0.4/specification/tables/ducklake_column_mapping.md %})
* [`ducklake_name_mapping`]({% link docs/0.4/specification/tables/ducklake_name_mapping.md %})

## Statistics

DuckLake supports statistics on the table, column and file level.

* [`ducklake_table_stats`]({% link docs/0.4/specification/tables/ducklake_table_stats.md %})
* [`ducklake_table_column_stats`]({% link docs/0.4/specification/tables/ducklake_table_column_stats.md %})
* [`ducklake_file_column_stats`]({% link docs/0.4/specification/tables/ducklake_file_column_stats.md %})
* [`ducklake_file_variant_stats`]({% link docs/0.4/specification/tables/ducklake_file_variant_stats.md %})

## Partitioning Information

DuckLake supports defining explicit partitioning.

* [`ducklake_partition_info`]({% link docs/0.4/specification/tables/ducklake_partition_info.md %})
* [`ducklake_partition_column`]({% link docs/0.4/specification/tables/ducklake_partition_column.md %})
* [`ducklake_file_partition_value`]({% link docs/0.4/specification/tables/ducklake_file_partition_value.md %})

## Sort Information

DuckLake supports defining a sort order for tables to improve query performance.

* [`ducklake_sort_info`]({% link docs/0.4/specification/tables/ducklake_sort_info.md %})
* [`ducklake_sort_expression`]({% link docs/0.4/specification/tables/ducklake_sort_expression.md %})

## Auxiliary Tables

* [`ducklake_metadata`]({% link docs/0.4/specification/tables/ducklake_metadata.md %})
* [`ducklake_tag`]({% link docs/0.4/specification/tables/ducklake_tag.md %})
* [`ducklake_column_tag`]({% link docs/0.4/specification/tables/ducklake_column_tag.md %})
* [`ducklake_schema_versions`]({% link docs/0.4/specification/tables/ducklake_schema_versions.md %})
