...
- `path_is_relative` whether the `path` is relative to the [`path`]({% link docs/0.4/specification/tables/ducklake_schema.md %}) of the schema (true) or an absolute path (false).
