...
The generated keys are stored in the catalog, in the `encryption_key` field of the [`ducklake_data_file`]({% link docs/0.4/specification/tables/ducklake_data_file.md %}) table.
