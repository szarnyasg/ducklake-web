...
- For tables and views, comments are in the [`ducklake_tag`]({% link docs/0.4/specification/tables/ducklake_tag.md %}) table.
- For columns, comments are in the [`ducklake_column_tag`]({% link docs/0.4/specification/tables/ducklake_column_tag.md %}) table.
