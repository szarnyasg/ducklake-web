...
This is used internally in the [data change feed]({% link docs/0.4/duckdb/advanced_features/data_change_feed.md %}) to differentiate between update operations and delete + insert operations.
