...
Arbitrary expressions are supported in `SET SORTED BY`, not just column references. This includes function calls, casts, and [DuckLake macros]({% link docs/0.4/duckdb/advanced_features/macros.md %}).
