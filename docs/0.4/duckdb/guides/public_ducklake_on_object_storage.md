...
Create a new DuckLake following the [“Using a Remove Data Path” guide]({% link docs/0.4/duckdb/guides/using_a_remote_data_path.md %}) using DuckDB as the catalog database and set the data path to the `https://` URL that serves your bucket.
